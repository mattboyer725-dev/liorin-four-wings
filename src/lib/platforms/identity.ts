...
export const THE_LINE = "You can't beat Liorin.";
...
export const LICHESS_BIO =
  "You can't beat Liorin. BOT-titled opponents only. Teach, then hold.";

export const LICHESS_CHAT =
  "You can't beat Liorin. BOT titles only. Teach, then hold.";
