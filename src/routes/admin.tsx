    ...
    <div className="flex flex-col gap-8">
      <header>
        ...
        <p className="mt-3 max-w-2xl text-sm leading-relaxed text-muted">
          Every finished game is kept — academy board, gauntlet, and public Lichess field games.
          The desk writes it cold, then points the reader back to the board, the lessons, and the
          2700 Club.
        </p>
      </header>
